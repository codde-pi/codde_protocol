...
// The type `Action` is not used by any `pub` functions, thus it is ignored.
// The type `ClickButton` is not used by any `pub` functions, thus it is ignored.
// The type `ClientStatus` is not used by any `pub` functions, thus it is ignored.
// The type `ConfirmButton` is not used by any `pub` functions, thus it is ignored.
// The type `DirectionalButton` is not used by any `pub` functions, thus it is ignored.
// The type `Joystick` is not used by any `pub` functions, thus it is ignored.
// The type `PressButton` is not used by any `pub` functions, thus it is ignored.
// The type `ToggleButton` is not used by any `pub` functions, thus it is ignored.
...
sealed class ResultBinding with _$ResultBinding {
  ...
  const factory ResultBinding.error(
    ErrorResult field0,
  ) = ResultBinding_Error;
}
