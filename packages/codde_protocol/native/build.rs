...
const DART_OUTPUT: &str = "../lib/src/frb_generated.dart";

const IOS_C_OUTPUT: &str = "../../flutter_codde_protocol/ios/Classes/frb.h";
const MACOS_C_OUTPUT_DIR: &str = "../../flutter_codde_protocol/macos/Classes/";
