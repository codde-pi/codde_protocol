    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    let mut api_that = api_that.rust_auto_opaque_decode_ref_mut();
                    crate::api::protocols::client::com_socket::ComSocketClient::disconnect(
                        &mut api_that,
                    )
                })())
            }
        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    ...
                    Result::<_, ()>::Ok(
                        crate::api::protocols::client::com_socket::ComSocketClient::is_connected(
                            &api_that,
                        ),
                    )
                })())
...
fn wire_ComSocketClient_new_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse((move || {
                Result::<_, ()>::Ok(
                    crate::api::protocols::client::com_socket::ComSocketClient::new(api_address),
                )
            })())
        },
    )
...
impl SseDecode for crate::api::models::widget_registry::Coord {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_x = <f32>::sse_decode(deserializer);
        let mut var_y = <f32>::sse_decode(deserializer);
        return crate::api::models::widget_registry::Coord { x: var_x, y: var_y };
    }
}

impl SseDecode for crate::api::models::widget_registry::ErrorResult {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_error = <String>::sse_decode(deserializer);
        return crate::api::models::widget_registry::ErrorResult { error: var_error };
    }
}
...
impl SseDecode for crate::api::models::widget_registry::ResultBinding {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            ...
            1 => {
                let mut var_field0 =
                    <crate::api::models::widget_registry::ErrorResult>::sse_decode(deserializer);
                return crate::api::models::widget_registry::ResultBinding::Error(var_field0);
            }
            _ => {
                unimplemented!("");
            }
...
impl SseDecode for crate::api::models::widget_registry::ResultRegistry {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            ...
            1 => {
                let mut var_error = <String>::sse_decode(deserializer);
                return crate::api::models::widget_registry::ResultRegistry::ErrorResult {
                    error: var_error,
                };
            }
            _ => {
...
impl SseDecode for crate::api::models::widget_registry::ServerStatus {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return match inner {
            0 => crate::api::models::widget_registry::ServerStatus::NotInit,
            1 => crate::api::models::widget_registry::ServerStatus::Idle,
            2 => crate::api::models::widget_registry::ServerStatus::Busy,
            3 => crate::api::models::widget_registry::ServerStatus::Error,
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            ...
            4 => {
                ...
                return crate::api::models::widget_registry::WidgetRegistry::DirectionalButton {
                    direction: var_direction,
                };
            }
            5 => {
                let mut var_delta =
                    <crate::api::models::widget_registry::Coord>::sse_decode(deserializer);
                let mut var_intensity = <f32>::sse_decode(deserializer);
                return crate::api::models::widget_registry::WidgetRegistry::Joystick {
                    delta: var_delta,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        14 => wire_ComSocketClient_new_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::models::widget_registry::Coord {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::models::widget_registry::Coord
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::models::widget_registry::Coord>
    for crate::api::models::widget_registry::Coord
{
    fn into_into_dart(self) -> crate::api::models::widget_registry::Coord {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::models::widget_registry::ErrorResult {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [self.error.into_into_dart().into_dart()].into_dart()
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::models::widget_registry::ErrorResult
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::models::widget_registry::ErrorResult>
    for crate::api::models::widget_registry::ErrorResult
{
    fn into_into_dart(self) -> crate::api::models::widget_registry::ErrorResult {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl flutter_rust_bridge::IntoDart for crate::api::models::widget_registry::ResultBinding {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            ...
            crate::api::models::widget_registry::ResultBinding::Error(field0) => {
...
impl flutter_rust_bridge::IntoDart for crate::api::models::widget_registry::ResultRegistry {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            ...
            crate::api::models::widget_registry::ResultRegistry::ErrorResult { error } => {
...
impl flutter_rust_bridge::IntoDart for crate::api::models::widget_registry::WidgetRegistry {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            ...
            crate::api::models::widget_registry::WidgetRegistry::DirectionalButton {
                direction,
            } => [4.into_dart(), direction.into_into_dart().into_dart()].into_dart(),
            crate::api::models::widget_registry::WidgetRegistry::Joystick { delta, intensity } => [
                5.into_dart(),
...
impl SseEncode for crate::api::models::widget_registry::Coord {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
...
impl SseEncode for crate::api::models::widget_registry::ErrorResult {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            ...
            crate::api::models::widget_registry::ResultBinding::Error(field0) => {
                ...
                <crate::api::models::widget_registry::ErrorResult>::sse_encode(field0, serializer);
            }
        }
    }
}
...
impl SseEncode for crate::api::models::widget_registry::ServerStatus {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(
            match self {
                crate::api::models::widget_registry::ServerStatus::NotInit => 0,
                crate::api::models::widget_registry::ServerStatus::Idle => 1,
                crate::api::models::widget_registry::ServerStatus::Busy => 2,
                crate::api::models::widget_registry::ServerStatus::Error => 3,
                _ => {
                    unimplemented!("");
                }
            },
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            ...
            crate::api::models::widget_registry::WidgetRegistry::Joystick { delta, intensity } => {
                ...
                <crate::api::models::widget_registry::Coord>::sse_encode(delta, serializer);
